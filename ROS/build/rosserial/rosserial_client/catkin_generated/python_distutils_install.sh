...
echo_and_run cd "/home/hammerhead/NO-TOUCH/KSU-Senior-Project-Fall-2021/ROS/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/hammerhead/NO-TOUCH/KSU-Senior-Project-Fall-2021/ROS/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/hammerhead/NO-TOUCH/KSU-Senior-Project-Fall-2021/ROS/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
